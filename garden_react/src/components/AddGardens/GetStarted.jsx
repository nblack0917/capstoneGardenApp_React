...
const getGardenLayout = async () => {
    ...
    axios.get(`https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/gardens/layout/${userID}`)
      .then((res) => {
...
const handleFinishLoadingUser = () => {
 ...
 const requestUserData = () => {
  ...
  const getLastBedId = async () => {
    ...
    axios.get('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/last_bed')
      .then((res) => {
  ...
  const getLastGardenId = async () => {
    ...
    axios.get('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/last_garden')
      .then((res) => {
        // console.log("get data", res.data)
...
const getLastUserId = async () => {
    ...
    axios.get('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/last_user')
      .then((res) => {
        // console.log("get data", res.data)
        gardenId = parseInt(res.data)
  ...
  const sendGardenData = async() => {
    ...
    let sendGarden = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/gardens/create', newGarden)
      .then((res) => {
    ...
    let sendBeds = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/gardens/create/beds', bedInfo)
    .then((res) => {
    ...
    let sendLayout = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/gardens/create/layout', layoutInfo)
    .then((res) => {
  ...
  const sendUserData = async() => {
    ...
    let sendUser = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/create/users', newUser)
      .then((res) => {
        console.log("update userGardens", res.status)
        setNewUserId(newId)
      }).catch((error) => console.log(error))
    ...
    let sendContact = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/create/contact', newUser)
    .then((res) => {
      console.log("update gardenBeds", res.status)
    }).catch((error) => console.log(error))
    ...
    let sendAddress = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/create/address', newUser)
    .then((res) => {
      console.log("update gardenLayout", res.status)
    }).catch((error) => console.log(error))
    ...
    let sendCredentials = await axios.post('https://4d8w99cyh7.execute-api.us-east-2.amazonaws.com/latest/users/create/credentials', newUser)
    .then((res) => {
      console.log("update gardenLayout", res.status)
    }).catch((error) => console.log(error))
