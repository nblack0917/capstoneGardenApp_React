...
class BedGrid extends React.Component {
    // static defaultProps = {
    //     className: "layout",
    //     items: itemNum,
    //     cols: 12,
    ...
    //   };
      constructor(props) {
        ...
        this.state = { layoutList: [
            ...
            {i: '0', x: 12, y: 0, w: 1, h: rowHeight, static: true, isPlanter: false},
          ],
        newSizes: [
      ...
      componentDidMount() {
        console.log("creategarden bedgrid",this.props.createGarden)
      }
  ...
  render() {
    ...
    return (
      <div className="bedContainer">
              <BedList createGarden={this.props.createGarden} removeBeds={false} handleUpdateItem={e => {this.handleUpdateItem(e)}} />
