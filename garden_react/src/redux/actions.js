...
export const getAllPlantsByType = (plantList) => {
    const byTypeUrl = "https://me16gqnge2.execute-api.us-east-2.amazonaws.com/latest/plants/plantTypes";
    return (dispatch) => {
        fetch(byTypeUrl)
            .then(res => res.json())
            .then(response => {
...
export const fetchUserbyUserName = (userName) => {
    ...
    const userInfoUrl = `https://me16gqnge2.execute-api.us-east-2.amazonaws.com/latest/users/${userName}`
...
export const fetchUserGardensById = (id) => {
    const userGardensUrl = `https://me16gqnge2.execute-api.us-east-2.amazonaws.com/latest/gardens/id/${id}`
    return (dispatch) => {
...
export const fetchUserGardenPlantsById = (id) => {
    const userGardenPlantsUrl = `https://me16gqnge2.execute-api.us-east-2.amazonaws.com/latest/users/gardens/${id}`
    return (dispatch) => {
